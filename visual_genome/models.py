...
class Image:
    ...
    def __str__(self):
        return "id: {}, coco_id: {}, flickr_id: {}, width: {}, height: {}, url: {}".format(
            self.id, -1 if self.coco_id is None else self.coco_id,
            -1 if self.flickr_id is None else self.flickr_id, self.width, self.height, self.url)
...
class Region:
    ...
    def __str__(self):
        ...
        return stat_str.format(self.id, self.x, self.y, self.width, self.height, self.phrase, self.image.id)
...
class Object:
    ...
    def __str__(self):
        ...
        return "{}(x:{},y:{},w:{},h:{})".format(name, self.x, self.y, self.width, self.height)
...
class Relationship:
    ...
    def __str__(self):
        return "{0}: {1} {2} {3}".format(self.id, self.subject, self.predicate, self.object)
