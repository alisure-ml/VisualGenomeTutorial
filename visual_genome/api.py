...
def get_all_image_ids():
    ...
    """
    page = 1
    _next = '/api/v0/images/all?page=' + str(page)
    ids = []
    while True:
        data = utils.retrieve_data(_next)
...
def get_region_graph_of_region(image_id=61512, region_id=1):
    ...
    data = utils.retrieve_data('/api/v0/images/' + str(image_id) + '/regions/' + str(region_id))
    if 'detail' in data and data['detail'] == 'Not found.':
        return None
